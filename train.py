...
# File: train.py
# Description: Custom training script for transformer model.
# Date: 23/04/2022
...
def train_model(preprocessor, base_model, frac_train_data, frac_val_data, batch_size=8, n_epoch=15, log_every=1,
                eval_every=10,
...
if __name__ == '__main__':
    ...
    train_model(preprocessor=SquadPlausibleAnswersPreprocessor, base_model=QAModel, frac_val_data=0.1, frac_train_data=0.9,
